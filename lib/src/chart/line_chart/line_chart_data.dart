...
class BarAreaData with EquatableMixin {
  ...
  BarAreaData({
    ...
    bool? applyCutOffY,
        ...
        color = color ??
            ((color == null && gradient == null) ? Colors.blueGrey.withOpacity(0.5) : null),
...
class FlDotCirclePainter extends FlDotPainter {
  ...
  void draw(Canvas canvas, FlSpot spot, Offset offsetInCanvas) {
    ...
    String valueWithDot = (value / 10).toStringAsFixed(1);
    final textSpan = TextSpan(text: valueWithDot, style: textStyle);
    final textPainter = TextPainter(text: textSpan, textDirection: TextDirection.ltr);

    textPainter.layout(minWidth: 0, maxWidth: 20);
    valueOffset ??= Offset(offsetInCanvas.dx - 10, offsetInCanvas.dy - 10);
  }
